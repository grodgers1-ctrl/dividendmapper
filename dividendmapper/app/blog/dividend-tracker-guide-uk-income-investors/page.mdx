  ...
  items={[
    {
      ...
      answer:
        "Portfolio tracking monitors your total investment value — share prices, asset allocation, and overall return. Dividend tracking specifically measures income: how much each holding pays, when, and how that income is trending over time. A portfolio tracker tells you whether you are richer or poorer; a dividend tracker tells you whether your income stream is growing.",
    },
    {
      question: "Do I need a paid dividend tracker as a UK investor?",
      answer:
        "Not necessarily. For a single-broker portfolio of 5 to 15 UK stocks, a well-structured free spreadsheet is sufficient. Paid trackers become valuable when you hold accounts at multiple brokers, need multi-currency support for US stocks, or want dividend-growth analytics for retirement planning.",
    },
    {
      question: "How does dividend tracking help with tax returns?",
      answer:
        "Good tracking gives you a per-tax-year, per-wrapper breakdown of your dividend income. At self-assessment time, you know exactly how much dividend income fell in the ISA (tax-free), the SIPP (tax-free while retained), and the GIA (taxable). Without tracking, you reconstruct your totals from broker statements.",
    },
    {
      question: "What is yield on cost?",
      answer:
        "Yield on cost is the dividend yield calculated using your original purchase price rather than the current share price. For a stock held for several years with growing dividends, yield on cost can be significantly higher than the current market yield. It is the most relevant metric for buy-and-hold income investors.",
    },
    {
      question: "Can a dividend tracker help me find better dividend stocks?",
      answer:
        "Indirectly. By tracking yield on cost and dividend growth across your existing holdings, you identify which positions are genuinely growing your income. That evidence informs future buying decisions — you know which characteristics have worked well for your portfolio.",
    },
    {
...
The honest answer depends on portfolio size, complexity, and whether you want your dividend income to grow predictably. This guide covers what dividend tracking actually means for a UK income investor, the three main approaches available, and how to decide when it is worth the effort.

---

## What is dividend tracking — and why it matters for UK income investors

Dividend tracking means recording each dividend payment your portfolio generates — the pay date, the amount received, any tax withheld, and the yield at the time of payment — and using that record to understand your portfolio's income performance over time.

It differs from generic portfolio tracking in a few important ways:

- **Yield on cost** — what yield you are earning on your original purchase price, not just the current market yield.
- **Dividend growth** — whether the companies you own are raising, cutting, or holding their payouts steady.
- **Ex-dividend dates** — knowing when the next payment is due and planning around the pay cycle.
...
| Portfolio | Tracking value |
|-----------|---------------|
| 1–3 stocks in a single ISA | Low — you can remember the totals |
| 5–15 stocks across 1–2 accounts | Medium — tracking helps with tax returns and reinvestment decisions |
...
The [Sharesight vs DividendMapper comparison](/blog/sharesight-vs-dividendmapper-uk-income-investors) covers where each approach fits different portfolio profiles, but the short version is: a dedicated tracker makes sense when cross-broker consolidation or detailed analytics justify the cost and data-sharing trade-off.
...
## What to track: the essential dividend metrics

### Dividend yield — trailing vs forward vs yield on cost

Three different yield numbers measure three different things:

- **Trailing yield** — dividends paid over the last 12 months ÷ current share price. This is what you see on most stock screeners. It tells you what the market currently prices the yield at, but it is backward-looking.
- **Forward yield** — the most recent dividend × expected frequency ÷ current share price. Forward-looking but depends on the company maintaining its payout.
- **Yield on cost** — total dividends received ÷ your original cost basis. This is the number that matters most to a buy-and-hold investor, because it tells you your personal return on what you actually paid. For a stock held for five years with growing dividends, yield on cost can be significantly higher than the current trailing yield — and that is exactly the point of holding income stocks long term.
...
The most undervalued metric for UK income investors. A stock yielding 4% with a 10-year record of consistent 5% annual dividend growth will produce meaningfully more income over a decade than a stock yielding 6% with flat or declining payouts. Tracking dividend growth per holding lets you distinguish genuine income compounders from high-yield traps.
...
The [Retirement Income Calculator](/tools/retirement-calculator) projects how much income your dividend portfolio could produce in the future, using Bear, Base, and Bull growth scenarios. The accuracy of those projections depends on knowing your portfolio's current dividend-growth trend — and that data comes from tracking.
...
- **Year 2:** Opens a SIPP with a second broker. Now tracking across three accounts. The spreadsheet becomes harder to maintain — misses one ex-dividend date, loses a reinvestment opportunity. The dividend-growth record, while patchy, now covers enough time to estimate per-stock trends.
- **Year 3:** Adopts a dedicated tracker that imports transaction history and auto-captures dividend events. Tracking time drops to ~10 minutes per month. Uses the tracker's dividend-growth data to feed the retirement calculator — now the Bear/Base/Bull scenarios are anchored in real portfolio behaviour rather than assumed averages.
...
1. **Ignoring FX on US-listed stocks.** If you hold US stocks like Coca-Cola or Johnson & Johnson, the dividend you receive in GBP depends on the exchange rate on the payment date. A tracker that ignores FX will show a misleading picture of your true dividend income.

2. **Mixing gross and net yields.** The headline yield on a stock screener is usually gross (before UK withholding tax for US stocks, or before your income tax). Your personal yield is the net amount that lands in your account.

3. **Ignoring special dividends and return-of-capital events.** One-off dividends and return-of-capital distributions are not recurring income. Counting them in your annual dividend total inflates your sustainable income estimate.

4. **Not tracking yield-on-cost separately from current yield.** A stock you bought five years ago at a 5% yield might now trade at a 3% trailing yield because the share price has risen. Your personal return — yield on cost — could be 7% or higher if dividends have grown.

5. **Forgetting to reconcile with the dividend allowance.** The £500 dividend allowance (2026/27) means tax only kicks in above that threshold. Without tracking, you might discover the tax bill only at self-assessment time.
...
Indirectly. By tracking yield on cost and dividend growth across your existing holdings, you identify which positions are genuinely growing your income — informing future buying decisions.

---

## Related guides

- The [Sharesight vs DividendMapper for UK Income Investors](/blog/sharesight-vs-dividendmapper-uk-income-investors) comparison covers where dedicated tracking fits different portfolio profiles.
- Use the [Retirement Income Calculator](/tools/retirement-calculator) with your tracking data to project future income.
- The [UK Dividend Tax Guide 2026/27](/blog/uk-dividend-tax-guide) explains allowance, rates, and wrapper rules that determine how much dividend income you keep.
- [Why Headline Yield Can Be Misleading](/blog/why-headline-yield-can-be-misleading) covers yield on cost, payout sustainability, and the difference between a high yield and a reliable one.

<PostFooter slug="dividend-tracker-guide-uk-income-investors" />