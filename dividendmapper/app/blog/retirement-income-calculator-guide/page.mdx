...
<FaqJsonLd
  items={[
    ...
    },
    {
      ...
      answer:
        "At least annually. Dividend growth rates change, your portfolio composition changes, and tax rules change. The dividend allowance has already fallen from £2,000 (2022/23) to £500 (2026/27), and further changes are possible, and your projections should reflect current rules.",
    },
  ]}
/>
  ...
  items={[
    {
      ...
      label: "Track the dividends you already own",
      description: "The calculator is only as good as the data you feed it. Step one is real tracking, not guessed yields.",
    },
    {
      href: "/blog/portfolio-tracking-dividend-income-uk-investors",
      label: "Manage the portfolio across wrappers",
      description: "The day-to-day workflow once tracking is in place: yield on cost, dividend growth, when to trim.",
    },
    {
      href: "/blog/sharesight-vs-dividendmapper-uk-income-investors",
      label: "Pick a tracker tool",
      description: "If you need a dedicated tool to feed the calculator with real data, see where each fits.",
    },
  ]}
/>
