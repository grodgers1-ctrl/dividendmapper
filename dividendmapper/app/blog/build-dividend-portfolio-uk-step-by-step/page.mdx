...
And if you want to use DividendMapper to track your own portfolio, [start for free](https://dividendmapper.com/login?next=/app/portfolio). Just keep the right expectation: the value of a dividend portfolio still comes from the underlying decisions, not from pretending a tool removes the need to think.
