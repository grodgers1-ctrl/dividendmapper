...
If you want to try DividendMapper's tracker instead of a spreadsheet, [it's free for up to 10 holdings](/login?next=/app/portfolio). Pro lifts the cap and adds resilience scoring across every holding.
