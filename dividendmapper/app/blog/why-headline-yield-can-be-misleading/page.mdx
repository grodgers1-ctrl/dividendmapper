...
A cheap account or wrapper can still matter, but it does not solve the separate question of dividend durability. If you are later comparing wrapper or broker options around that question, the [Trading 212 SIPP review](/blog/trading-212-sipp-review) can be useful background. It should stay out if the discussion is purely about yield quality.
