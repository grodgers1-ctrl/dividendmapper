  ...
  items={[
    {
      ...
      description: "Valuation is one half of the work. Tracking what you actually own is the other. Start with the tracker basics.",
    },
    {
      href: "/blog/retirement-income-calculator-guide",
      label: "Project the income picture",
      description: "Roll per-stock value up into a portfolio retirement-income range across Bear, Base, and Bull scenarios.",
    },
    {
...
<PostFooter
  nextHref="/tools/dcf-calculator"
  nextLabel="Try the DCF calculator on a stock you already own"
/>