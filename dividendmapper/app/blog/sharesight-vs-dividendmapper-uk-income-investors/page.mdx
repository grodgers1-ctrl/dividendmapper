...
DividendMapper's live pricing is simpler: Free covers up to 10 holdings and Pro is £15 a month for unlimited. That is a cleaner offer, but it also sits inside a younger product with a narrower scope.
...
If you want to test the income-planning side first, try the [retirement calculator](/tools/retirement-calculator). If the comparison made you realise you want a more wrapper-aware dividend workflow, [start tracking for free](/login?next=/app/portfolio).
  ...
  items={[
    {
      ...
      label: "What a tracker should actually give you",
      description: "If you are not yet sure what to look for in a tracker, this covers the metrics worth measuring before picking a tool.",
    },
    {
      href: "/blog/portfolio-tracking-dividend-income-uk-investors",
      label: "Manage the portfolio across wrappers",
      description: "Once you choose a tool, the practical workflow: ISA, SIPP, and GIA tracking, yield on cost, and rebalancing for income.",
    },
    {
      href: "/tools/retirement-calculator",
      label: "Project what the portfolio could pay",
      description: "Skip the tool choice for a moment and try the retirement calculator if you came for the outcome, not the workflow.",
    },
  ]}
/>

<PostFooter
  nextHref="/login?next=/app/portfolio"
  nextLabel="Start tracking for free if you want a wrapper-first dividend workflow"
/>
