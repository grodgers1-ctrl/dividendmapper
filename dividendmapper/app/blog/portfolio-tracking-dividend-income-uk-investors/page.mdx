  ...
  items={[
    {
      ...
      label: "Start with the tracker basics",
      description: "The prequel: what dividend tracking is and the threshold where a spreadsheet stops being enough.",
    },
    {
      href: "/blog/sharesight-vs-dividendmapper-uk-income-investors",
      label: "Sharesight vs DividendMapper, honestly",
      description: "Where dedicated tracker tools fit, and where they overlap with the wrapper-first income lens.",
    },
    {
      href: "/tools/retirement-calculator",
      label: "Project the retirement-income side",
      description: "Three scenarios, your wrapper mix, and what your tracked income could compound to.",
    },
  ]}
/>

<PostFooter
  nextHref="/blog/dividend-tracker-guide-uk-income-investors"
  nextLabel="If you are new to dividend tracking, start with the basics first"
/>