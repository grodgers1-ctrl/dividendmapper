...
const PATTERNS: Array<[RegExp, Sector]> = [
  ...
  [/Tobacco|Beverage|Household|Personal Products|Packaged Foods/i, "consumer_staples"],
  [/Retail|Apparel|Auto|Hotel|Restaurant|Leisure|Luxury/i, "consumer_discretionary"],
  ...
  [/Software|Semiconductor|Computer|Internet|IT Services/i, "technology"],
